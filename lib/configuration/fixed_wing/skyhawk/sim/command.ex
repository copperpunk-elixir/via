defmodule Configuration.FixedWing.Skyhawk.Sim.Command do
      ...
      RemotePilot: [
        ...
        current_pcl_channel_config: %{
          CCT.pilot_control_level_4() => %{
            ...
            SGN.altitude_rate_mps() => {1, {-5.0, 0, 5.0, CCT.input_not_inverted(), 0.05}},
          ...
          CCT.pilot_control_level_2() => %{
            ...
            SGN.pitch_rad() => {1, {-0.52, 0, 0.52, CCT.input_not_inverted(), 0.017}},
          ...
          CCT.pilot_control_level_1() => %{
            ...
            SGN.pitchrate_rps() => {1, {-3.14, 0, 3.14, CCT.input_not_inverted(), 0.087}},
        ...
        any_pcl_channel_config: %{
          SGN.flaps_scaled() => {4, {-1, 0, 1.0, CCT.input_not_inverted(), -0.99}},
          SGN.gear_scaled() => {9, {-1, 0, 1.0, CCT.input_inverted(), -0.99}},
