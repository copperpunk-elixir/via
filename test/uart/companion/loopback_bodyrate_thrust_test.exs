defmodule Uart.Companion.LoopbackBodyrateThrottle do
  use ExUnit.Case
  require Logger
  ...
  test "Open Serial Port", full_config do
   ...
   # Expects comments from Gps operator
    uart_config = Configuration.FixedWing.Cessna2m.Sim.Uart.config(["FrskyRx_CP2104", "Companion_Pico", "Gps_u-blox"])
