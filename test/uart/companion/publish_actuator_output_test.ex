defmodule Uart.Companion.PublishActuatorOutput do
  use ExUnit.Case
  require Logger
  ...
  test "Open Serial Port", full_config do
    uart_debug_config = [name: "Pico", uart_port: "Pico", port_options: [speed: 115_200]]
    ...
    uart_config =
      Configuration.FixedWing.Cessna.Sim.Uart.config([
        "FrskyRx_CP2104",
        "Companion_Pico",
        "Gps_u-blox"
      ])
    ...
    config = Configuration.FixedWing.Cessna.Sim.Control.config()
