defmodule ReceiveAccelGyroTest do
  use ExUnit.Case
  require Logger
  ...
  test "Open Serial Port" do
    Ubx.Utils.Test.start_link([groups: [:accel_gyro_val], destination: self()])
    ...
    msg = Ubx.Utils.Test.build_message(:accel_gyro_val, accel_gyro_values)
